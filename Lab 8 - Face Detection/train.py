...
class Unit(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        #  similar to hidden layer but for images in 2d
...
class SimpleNet(nn.Module):
    ...
    def __init__(self, num_classes=2):
        ...
        self.unit1 = Unit(in_channels=3, out_channels=32)  # 3 from RGB
...
def save_models(model, epoch):
    torch.save(model.state_dict(), "models/model_{}.models".format(epoch))
...
if __name__ == "__main__":
    ...
    train(model, optimizer, loss_fn, train_loader, test_loader, 100)
